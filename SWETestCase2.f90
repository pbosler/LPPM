...
real(kreal), parameter :: g = 11490.1_kreal
real(kreal), parameter :: h0 = 0.00047055_kreal
...
do timeJ = 0, nTimesteps - 1
	...
	call Timestep( solver, sphere, dt, pseSetup )
	call SetFieldToZero(sphere%divergence)
...
function TestCase2Vorticity( x, y, z)
...
function TestCase2Divergence( x, y, z )
	real(kreal) :: TestCase2Divergence
	real(kreal), intent(in) :: x, y, z
	TestCase2Divergence = 0.0_kreal
end function

function TestCase2Velocity( x, y, z )
